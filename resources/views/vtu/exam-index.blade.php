<x-app-layout>
    <div class="mx-auto max-w-5xl space-y-8">
        <section>
            <h1 class="app-page-title text-[2.1rem] sm:text-[2.6rem]">Education Services</h1>
                ...
                <a href="{{ route('vtu.exam.service', $slug) }}" class="app-service-card block">
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            ...
                            <div class="mt-2 text-sm text-slate-500">Open a dedicated page for this education product.</div>
                        </div>
